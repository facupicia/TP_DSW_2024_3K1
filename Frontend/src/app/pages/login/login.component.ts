import { Component, inject, PLATFORM_ID, NgZone, OnInit } from '@angular/core';
...
export class LoginComponent implements OnInit {
  ...
  private renderGoogleButton(g: any) {
    try {
      ...
      console.log(`Inicializando Google Auth - Modo: ${uxMode}, Safari iOS: ${this.isSafariIOS}, FedCM: ${useFedCM}`);
  ...
  private renderSafariFallbackButton(container: HTMLElement, g: any): void {
    ...
    // Crear botón personalizado estilizado como Google
    ...
    button.addEventListener('click', () => {
      ...
      g.accounts.id.prompt((notification: any) => {
        if (notification.isNotDisplayed() || notification.isSkippedMoment()) {
          ...
          console.log('Google prompt no disponible, usando redirect...');
        }
      });
    });
    
    container.appendChild(button);
    console.log('Botón personalizado para Safari iOS renderizado');
  }
